...
<td><x-admin-document-button href="{{ route('admin.registrant',$agency->user_id) }}" /><details class="agency-actions"><summary aria-label="Tindakan {{ $agency->name }}">•••</summary><div>
<x-admin-document-button href="{{ route('admin.registrant',$agency->user_id) }}" />
